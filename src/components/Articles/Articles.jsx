    ...
    /*<div>
        ...
        <div className="card shadow p-3 mb-5 bg-white rounded" >
            ...
            <div className="card-body body-left p-3 col align-self-center">
                ...
                <p className="card-text text-dark">Some quick example text to build on the card title and make up the bulk of the card's content.le film a l'intelligence de ne jamais lâcher un fil conducteur amorcé dès l'épisode VII : l'opposition singulière, en forme d'amour-haine, entre Rey et Kylo Ren. On vibre à chacun de leurs combats, à chaque tentative de rapprochement, magnifiés par les interprétations éblouissantes de Daisy Ridley et Adam Driver qui maîtrisent mieux que jamais leurs personnages au bout de trois films.</p>
            </div>
        </div>
    </div>*/
    <div class="container card-group">
        <div class="CardComponent1 card p-3">
            <div className="cardHeader">
                <h2 className="text-dark">The Empire Strikes Back</h2>
                <p className="text-dark">December 13, 2021</p>
                <p className="cinema">Last Jedi</p>

            </div>
            <img src={Simo.image} className="card-img-top p-1" alt={Simo.name} />
            <div className="card-body">
                <h5 className="card-title">Find out what the French press thinks of Star Wars 
The Last Jedi, in theaters today.</h5>
                <p className="text-dark">
      The highly anticipated eighth installment of the Star Wars saga was released in theaters today. If the first reactions of the American media were positive, what did the French press think.
...
you speechless when faced with its crazy sense of setting and scale.</p>
        ...
        <div className="cardHeader">
                <h2 className="text-dark">The Empire Strikes Back</h2>
                <p className="text-dark">January 23, 2022</p>
                <p className="cinema">Cinema</p>

            </div>
            <img src={Empire.image} className="card-img-top" alt={Empire.name} />
            <div className="card-body">
                <h5 className="card-title">The Empie strikes Back</h5>
                <p className="card-text text-dark">[Not as good as The Empire Strikes Back], 
                ...
                perhaps too much sometimes, so many characters embark on parallel
                 ...
                 fans of the two previous trilogies.</p>
                <p className="card-text"><small className="text-muted">Last updated 3 mins ago</small></p>
            </div>
        </div>
        <div class="CardComponent3 card p-3">
        <div className="cardHeader">
                <h2 className="text-dark">The Empire Strikes Back</h2>
                <p className="text-dark">May 24, 2022</p>
                <p className="cinema">Cinema</p>

            </div>
            <img src={Parc.image} className="card-img-top" alt={Parc.name} />
            <div className="card-body">
                <h5 className="card-title">Parc</h5>
                <p className="card-text text-dark">Novembre 3, 2020
...
Because until June 23, the park will only be accessible to people who have managed to reserve a ticket (149 dollars) when it goes on sale, which sells out in less than two hours.</p>
